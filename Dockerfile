...
ENV C_INCLUDE_PATH=/opt/riscv/riscv64-unknown-elf/include/
ENV LD_LIBRARY_PATH=/opt/riscv/riscv64-unknown-elf/lib/
ENV CC=/opt/riscv/bin/riscv64-unknown-elf-gcc
ENV CXX=/opt/riscv/bin/riscv64-unknown-elf-g++
